...
// create table
  ...
  //add data in table
  Future<void> insertData(String name, String chat, String phone, String img,
...
// show data in table
  ...
  Future<void> updateInfo(
      String name, String chat, String phone, String img, int id) async {
    Database? db = await database;
    String sql =
        '''UPDATE Contact SET name = ?,chat = ?,phone = ?,img = ? WHERE id = ?;
    ''';
